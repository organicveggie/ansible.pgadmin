...
echo "pip install molecule molecule-plugins \"molecule[docker]\" molecule-vagrant tox"
pip install molecule molecule-plugins "molecule[docker]" molecule-vagrant tox
